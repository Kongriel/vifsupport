...
export default function EventPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen mt-4 md:-mt-10 md:px-12 px-4 overflow-x-hidden">
        <div className="flex flex-col items-center mt-24 justify-center">
          ...
          <p className="font-montserrat md:font-semibold text-xl md:text-center text-center md:mt-0 -mt-10 mb-12 md:mb-12 max-w-[700px] text-bono-10">Bliv en del af fællesskabet! Tjek vores kommende events og gør en forskel som frivillig – vi glæder os til at se dig!</p>
          <hr className="w-full border-knap-10 mb-12" />
        </div>
